...
\setlist[itemize]{nosep,left=0pt,topsep=2pt} % Tighten itemize spacing
...
\geometry{
	...
	vmargin=0.25cm, % Vertical margin
...
\definecolor{headings}{HTML}{003C71} % Dark red colour for headings
\definecolor{shade}{HTML}{dcfbff} % Peach colour for the contact information box
